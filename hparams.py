...
wst_ref_gru_hidden = 256
wst_size = 128
wst_n_style_token = 10
wst_n_style_attn_head = 4
...
checkpoint_path = os.path.join("./ckpt/", dataset, run_name)
synth_path = os.path.join("./synth/", dataset, run_name)
log_path = os.path.join("./log/", dataset, run_name)
test_path = os.path.join("./results/", dataset, run_name)
